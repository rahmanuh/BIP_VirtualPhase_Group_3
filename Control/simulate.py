...
def singleSimulation(T_inf=298.15, T0=363.15, h=0.7, A=1.0, m=0.1, c_p=1.2):
    ...
    # simulationCommand='./NewtonCooling.exe -override T_inf='+str(T_inf)+',T0='+str(T0)+',h='+str(h)+',A='+str(A)+',m='+str(m)+',c_p='+str(c_p)
...
# The following function is an alternative way of executing/simulating the Modelica model using the OMPython package. This method is not recommended.
